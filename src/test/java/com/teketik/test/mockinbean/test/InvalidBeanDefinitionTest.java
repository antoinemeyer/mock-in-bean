...
import com.teketik.test.mockinbean.test.components.TestComponentWithInvalidMockableComponent;
...
@ActiveProfiles("altering-component")
        ...
        public void beforeTestMethod(TestContext testContext) throws Exception {
            try {
                ...
                Assertions.assertEquals(
                    "Resolved invalid target beans for definition Definition [name=mockableComponent1, resolvableType=com.teketik.test.mockinbean.test.components.MockableComponent1] in "
                        + "InBeanDefinition [clazz=class com.teketik.test.mockinbean.test.components.TestComponentWithInvalidMockableComponent, name=null]",
                    e.getMessage()
                );
            }
        }
